...
import 'package:fl_app_tigo/screens/form_fallas.dart';
...
class TelefoniaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Areá de Servicios de Telefonia'),
        ),
        body: Column(
          children: [
  ...
  Container _btnprom() {
    return Container(
      ...
      child: ElevatedButton(
          ...
          child: const Text(
            'Conoce más sobre nuestras promociosnes',
          )),
    );
  }
}
